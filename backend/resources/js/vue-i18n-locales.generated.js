export default {
    "ar": {
        ...
        "words": {
            ...
            "training-disclosure": "الإفصاح عن التدريب",
            "training-disclosure-hq-intro": "من هنا تدير الدورات المسجلة للشركات: التسجيل، روابط الدخول، الحضور، التقدم، واعتماد الشهادات.",
            "training-disclosure-stat-companies": "شركات مسجلة",
            "training-disclosure-stat-enrollments": "تسجيلات",
            "training-disclosure-stat-checked-in": "حضور",
            "training-disclosure-stat-completed": "مكتمل",
            "training-disclosure-stat-pending": "بانتظار اعتماد الشهادة",
            "training-disclosure-stat-sent": "شهادات مرسلة",
            "training-disclosure-card-courses-title": "إدارة الدورات المسجلة",
            "training-disclosure-card-courses-body": "أنشئ الدورات، أضف الدروس والفيديوهات، واضبط جدول الفتح.",
            "training-disclosure-card-companies-title": "تسجيل الشركات والموظفين",
            "training-disclosure-card-companies-body": "افتح دورة ثم سجل موظفي الشركة وتابع تقدمهم واستحقاق الشهادة.",
            "training-disclosure-courses-list": "الدورات",
            "training-disclosure-pending-queue": "طابور اعتماد الشهادات",
            "training-disclosure-pending-queue-help": "موظفون أكملوا الدورة وينتظرون اعتماد وإرسال الشهادة.",
            "training-disclosure-no-pending": "لا توجد شهادات بانتظار الاعتماد حاليا.",
            "training-disclosure-process-title": "مسار العمل",
            "training-disclosure-step-1": "أنشئ الدورة المسجلة وأضف الدروس والفيديوهات.",
            "training-disclosure-step-2": "سجل موظفي الشركة وأرسل روابط الدخول الفريدة عبر البريد.",
            ...
            "recorded-course-lesson-video-optional": "فيديو الدرس (اختياري — الملفات الكبيرة ترفع على دفعات)",
            "recorded-course-create-videos-on-edit": "تضاف فيديوهات الدروس في الشاشة التالية بعد الحفظ. يمكنك رفع أو استبدال فيديو كل درس على حدة.",
            "recorded-course-edit-lesson-videos-hint": "ارفع أو استبدل الفيديو لكل درس أدناه. احفظ عند الانتهاء؛ ترفع الملفات الكبيرة تلقائيا على دفعات.",
            "recorded-course-created-add-videos": "تم حفظ الدورة. يمكنك إضافة فيديوهات الدروس أدناه عندما تكون جاهزا.",
            "recorded-course-uploading-large-videos": "جاري رفع مقاطع الفيديو الكبيرة… قد يستغرق ذلك وقتا.",
            "recorded-course-video-upload-one-method": "استخدم إما رفع الملف مباشرة أو رفعا مجزأ مكتملا، وليس الاثنين معا.",
            "recorded-course-help-unlock": "بعد أن يكمل المتدرب درسا، يفتح الدرس التالي بعد هذا العدد من الساعات. يمكن البدء بالمشاهدة فقط في أيام الأسبوع المحددة.",
            ...
            "recorded-course-complete-not-allowed": "لا يمكن اعتبار هذا الدرس مكتملا بعد.",
            "recorded-course-enrollment-team-mismatch": "يجب أن يكون المتدرب في نفس فريق الدورة.",
            "recorded-course-enrollment-already-exists": "المتدرب مسجل مسبقا في هذه الدورة.",
            ...
            "trainee-engineer-recorded-courses-body": "هذا المتدرب معلم كمهندس. سجله في دورة مسجلة ليتابع الدروس من لوحة تحكمه.",
            ...
            "recorded-course-trainee-id": "معرف المتدرب (UUID)",
            ...
            "recorded-course-check-in-required": "يرجى تسجيل الحضور قبل المتابعة.",
            "recorded-course-bulk-enroll-title": "تسجيل موظفي الشركة",
            "recorded-course-bulk-enroll-submit": "تسجيل وإرسال الروابط",
            "recorded-course-bulk-enrolled": "تم تسجيل {created} متدرب. تم تخطي {skipped} مسجل مسبقا.",
            "recorded-course-bulk-enroll-help": "اختر شركة، راجع موظفيها، ثم سجلهم وأرسل روابط الدورة الفردية.",
            "recorded-course-company-manage-intro": "سجل موظفي شركة، تابع تقدمهم في الدروس، واعتمد الشهادات عند استحقاقها.",
            "recorded-course-summary-enrolled": "مسجلون",
            "recorded-course-summary-checked-in": "سجلوا حضورا",
            "recorded-course-summary-completed": "أكملوا",
            "recorded-course-summary-eligible": "مستحقون للشهادة",
            "recorded-course-summary-cert-sent": "شهادات مرسلة",
            "recorded-course-filter-company": "تصفية حسب الشركة",
            "recorded-course-filter-all-companies": "كل الشركات",
            "recorded-course-progress": "التقدم",
            "recorded-course-entitlement": "استحقاق الشهادة",
            "recorded-course-entitlement-not_started": "لم يبدأ",
            "recorded-course-entitlement-in_progress": "قيد التقدم",
            "recorded-course-entitlement-eligible": "مستحق — بانتظار الاعتماد",
            "recorded-course-entitlement-certificate_sent": "تم إرسال الشهادة",
            "recorded-course-already-enrolled-badge": "مسجل مسبقا",
            "recorded-course-select-unenrolled": "تحديد غير المسجلين",
            "recorded-course-company-no-trainees": "لا يوجد متدربون في هذه الشركة للتسجيل.",
            "recorded-course-access-link-resent": "تمت إعادة إرسال رابط الدخول.",
            "recorded-course-certificate-not-pending": "هذا التسجيل ليس بانتظار اعتماد الشهادة.",
            "recorded-course-certificate-approved-queued": "تم اعتماد الشهادة وإضافتها لطابور الإرسال.",
            "recorded-course-link-sent": "إرسال الرابط",
            "recorded-course-check-in": "حضور",
            "recorded-course-check-out": "انصراف",
            "recorded-course-certificate-status": "الشهادة",
            "recorded-course-delivery-status": "التسليم",
            "recorded-course-resend-link": "إعادة إرسال الرابط",
            "recorded-course-approve-send-certificate": "اعتماد وإرسال الشهادة",
            "recorded-course-cert-status-none": "لا يوجد",
            "recorded-course-cert-status-pending_approval": "بانتظار الاعتماد",
            "recorded-course-cert-status-approved": "معتمدة",
            "recorded-course-cert-status-sent": "مرسلة",
            "recorded-course-cert-status-failed": "فشل",
            "recorded-course-setup-title": "أعد دورتك في خطوات واضحة",
            ...
            "recorded-course-schedule-description": "متى يفتح الدرس التالي وأي أيام الأسبوع يسمح بمشاهدة الفيديو.",
    ...
    "en": {
        ...
        "words": {
            ...
            "training-disclosure": "Training disclosure",
            "training-disclosure-hq-intro": "Manage company recorded-course programs from here: enrollments, access links, attendance, progress, and certificate approval.",
            "training-disclosure-stat-companies": "Companies enrolled",
            "training-disclosure-stat-enrollments": "Enrollments",
            "training-disclosure-stat-checked-in": "Checked in",
            "training-disclosure-stat-completed": "Completed",
            "training-disclosure-stat-pending": "Pending certificate approval",
            "training-disclosure-stat-sent": "Certificates sent",
            "training-disclosure-card-courses-title": "Manage recorded courses",
            "training-disclosure-card-courses-body": "Create courses, add lessons and videos, and set unlock schedules.",
            "training-disclosure-card-companies-title": "Company & employee enrollment",
            "training-disclosure-card-companies-body": "Open a course to enroll company employees and track progress and certificate entitlement.",
            "training-disclosure-courses-list": "Courses",
            "training-disclosure-pending-queue": "Certificate approval queue",
            "training-disclosure-pending-queue-help": "Employees who finished the course and are waiting for certificate approval and send.",
            "training-disclosure-no-pending": "No certificates are waiting for approval right now.",
            "training-disclosure-process-title": "Process",
            "training-disclosure-step-1": "Create the recorded course and add lessons and videos.",
            "training-disclosure-step-2": "Enroll company employees and email unique access links.",
            ...
            "recorded-course-check-in-required": "Please check in before continuing.",
            "recorded-course-bulk-enroll-title": "Enroll company employees",
            "recorded-course-bulk-enroll-submit": "Enroll & send links",
            "recorded-course-bulk-enrolled": "Enrolled {created} trainee(s). Skipped {skipped} already enrolled.",
            "recorded-course-bulk-enroll-help": "Pick a company, review its employees, then enroll them and email unique course links.",
            "recorded-course-company-manage-intro": "Enroll a company’s employees, track their lesson progress, and approve certificates when they become entitled.",
            "recorded-course-summary-enrolled": "Enrolled",
            "recorded-course-summary-checked-in": "Checked in",
            "recorded-course-summary-completed": "Completed",
            "recorded-course-summary-eligible": "Eligible for cert",
            "recorded-course-summary-cert-sent": "Certificates sent",
            "recorded-course-filter-company": "Filter by company",
            "recorded-course-filter-all-companies": "All companies",
            "recorded-course-progress": "Progress",
            "recorded-course-entitlement": "Certificate entitlement",
            "recorded-course-entitlement-not_started": "Not started",
            "recorded-course-entitlement-in_progress": "In progress",
            "recorded-course-entitlement-eligible": "Eligible — awaiting approval",
            "recorded-course-entitlement-certificate_sent": "Certificate sent",
            "recorded-course-already-enrolled-badge": "Already enrolled",
            "recorded-course-select-unenrolled": "Select not-yet-enrolled",
            "recorded-course-company-no-trainees": "This company has no trainees to enroll.",
            "recorded-course-access-link-resent": "Access link resent.",
            "recorded-course-certificate-not-pending": "This enrollment is not waiting for certificate approval.",
            "recorded-course-certificate-approved-queued": "Certificate approved and queued for sending.",
            "recorded-course-link-sent": "Link sent",
            "recorded-course-check-in": "Check-in",
            "recorded-course-check-out": "Check-out",
            "recorded-course-certificate-status": "Certificate",
            "recorded-course-delivery-status": "Delivery",
            "recorded-course-resend-link": "Resend link",
            "recorded-course-approve-send-certificate": "Approve & send certificate",
            "recorded-course-cert-status-none": "None",
            "recorded-course-cert-status-pending_approval": "Pending approval",
            "recorded-course-cert-status-approved": "Approved",
            "recorded-course-cert-status-sent": "Sent",
            "recorded-course-cert-status-failed": "Failed",
